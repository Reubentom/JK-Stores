                    ...
                    <div class="row">
                        <div class="col-12 d-flex align-items-center justify-content-between">
                            ...
                            <div class="header-logo">
                                <div class="logo">
                                    <a href="<?php echo base_url();?>"><img src="<?php echo base_url();?>assets/images/logo/logo.png" alt=""></a>
                                </div>
                            </div>
                            <!-- End Header Logo -->
                            ...
                            <div class="main-menu menu-color--black menu-hover-color--golden">
                                <nav>
                                    <ul>
                                                ...
                                                <div class="menu-banner">
                                                    <a href="#" class="menu-banner-link">
                                                        <img class="menu-banner-img"
                                                            src="<?php echo base_url();?>assets/images/banner/menu-banner.jpg" alt="">
                                                    </a>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="has-dropdown">
                                            <a href="<?php echo base_url();?>welcome/login">Login <i
                                                    class="fa "></i></a>
                                        ...
                                        <li>
                                            <a href="<?php echo base_url();?>login1">User Account</a>
        ...
        <div class="offcanvas-add-cart-wrapper">
            ...
            <ul class="offcanvas-cart">
                <li class="offcanvas-cart-item-single">
                    <div class="offcanvas-cart-item-block">
                        <a href="#" class="offcanvas-cart-item-image-link">
                            <img src="<?php echo base_url();?>assets/images/product/default/home-1/default-1.jpg" alt=""
                ...
                <li class="offcanvas-cart-item-single">
                    <div class="offcanvas-cart-item-block">
                        <a href="#" class="offcanvas-cart-item-image-link">
                            <img src="<?php echo base_url();?>assets/images/product/default/home-2/default-1.jpg" alt=""
                                class="offcanvas-cart-image">
                        </a>
                        <div class="offcanvas-cart-item-content">
                ...
                <li class="offcanvas-cart-item-single">
                    <div class="offcanvas-cart-item-block">
                        <a href="#" class="offcanvas-cart-item-image-link">
                            <img src="<?php echo base_url();?>assets/images/product/default/home-3/default-1.jpg" alt=""
                                class="offcanvas-cart-image">
                        </a>
                        <div class="offcanvas-cart-item-content">
