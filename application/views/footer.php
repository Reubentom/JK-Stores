...
<footer class="footer-section footer-bg">
        <div class="footer-wrapper">
                    ...
                    <div class="row mb-n6">
                        <div class="col-lg-3 col-sm-6 mb-6">
                            ...
                            <div class="footer-widget-single-item footer-widget-color--golden" data-aos="fade-up"
                                ...
                                <ul class="footer-nav">
                                    <li><a href="" disabled>Delivery Information</a></li>
                                    <li><a href="" disabled>Terms & Conditions</a></li>
                                    <li><a href="" disabled>Contact</a></li>
                                    <li><a href="" disabled>Returns</a></li>
                                </ul>
                            </div>
                        ...
                        <div class="col-lg-3 col-sm-6 mb-6">
                            ...
                            <div class="footer-widget-single-item footer-widget-color--golden" data-aos="fade-up"
                                ...
                                <ul class="footer-nav">
                                    <li><a href="<?php echo base_url();?>useraccount">User account</a></li>
                                    <li><a href="<?php echo base_url();?>adminaccount/login">Admin Account</a></li>
                                    <!-- <li><a href="privacy-policy.html">Privacy Policy</a></li> -->
                                    <li><a href="<?php echo base_url();?>vendorLogin/open">Vendor Account</a></li>
          ...
          <span>Email: </span> <div><a href="mailto:jkstores4life@example.com">jkstores4life@example.com</a></div>
                    ...
                    <div
                        ...
                        <div class="col-auto mb-6">
                            <div class="footer-copyright">
                                <p class="copyright-text">&copy; 2021 <a href="index.html">JK Stores</a>
